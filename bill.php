    ...
    <div class="container text-center">
        <div class="row text-center">
            <div class="wrapper-header text-center">
                ...
                <h3 class="wrapper-title1 top">Mahaveer Super Bazar</h3>
                <p class="wrapper-title1">Chinchwad, Kolhapur</p>
                <h4 class="wrapper-title1">GST IN: ABCDEFGHIJ</h4>
                <h4 class="wrapper-title2">Phone: 9876543210</h4>
...
?>
    ...
    <script>
        ...
        $(document).ready(function () {
              print_screen();
              setTimeout(function() { 
                window.location.replace("bill_ongoing.php");
               }, 3000);
        });
    </script>
</body>
